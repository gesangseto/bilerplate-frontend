              ...
              <CRow>
                ...
                <CCol md="6">
                  <table style="width: 100%">
                    ...
                    <tr style="height: 50px" v-if="rework.status == 2">
                      <td style="width: 40%">Reason</td>
                      <td style="width: 60%">
                        <textarea
                          class="form-control"
                          readonly
                          v-model="rework.reason"
                        />
                      </td>
                    </tr>
                  </table>
