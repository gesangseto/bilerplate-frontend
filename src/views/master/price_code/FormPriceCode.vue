          ...
          <CCardBody>
            <CForm>
              ...
              <InputDefault
                ...
                required
                title="Name"
                placeholder="Example: Regular Price"
              ...
              <InputDefault
                ...
                :is-valid="initial_load ? null : formData.number !== '' && formData.number !== null && formData.number !== undefined"
              />
...
export default {
  ...
  methods: {
    async loadData() {
      const result = await getMstPriceCode({ id: this.$route.params.id });
    ...
    async save() {
      ...
      const result = payload.id
        ? await updateMstPriceCode(payload)
        : await insertMstPriceCode(payload);
