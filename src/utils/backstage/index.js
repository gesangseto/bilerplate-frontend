  ...
  let menu = {
    ...
    items: [
      ...
      },
      {
        ...
        mst_menu_id: 200,
        icon: '',
        label: 'BPOM Compare Tool',
        link: '/development_tools/bpom_compare_tool',
        _name: 'CSidebarNavItem',
        can_view: 'true',
        can_add: 'true',
        can_edit: 'true',
        ...
        can_print: 'true',
        can_approve: 'true',
        name: 'BPOM Compare Tool',
        route: null,
        to: '/development_tools/bpom_compare_tool',
        type: 0,
        path: '/development_tools/bpom_compare_tool',
        show_create: 1,
        show_read: 1,
        show_update: 1,
        show_delete: 1,
